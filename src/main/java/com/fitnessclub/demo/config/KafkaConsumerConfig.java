package com.fitnessclub.demo.config;

import com.fasterxml.jackson.databind.JsonDeserializer;
import com.fitnessclub.demo.Entity.Deserialization;
...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Information> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Information> factory
